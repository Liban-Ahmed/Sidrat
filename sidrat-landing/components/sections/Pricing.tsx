...
export function Pricing() {
    return (
        <section id="pricing" className="py-20 sm:py-24 md:py-32 lg:py-40 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden scroll-mt-8">
            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20 xl:px-40 max-w-[1400px] relative z-10">
                ...
                <motion.div
                    ...
                    className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24 space-y-5 sm:space-y-8"
                >
                    <div className="inline-block px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-accent/20 to-accent/10 border border-accent/30 mb-4 sm:mb-6">
                ...
                >
                    ...
                    <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl sm:rounded-[40px] md:rounded-[48px] p-5 sm:p-8 md:p-12 lg:p-16 border border-white/50 shadow-2xl">
                        {/* Badge */}
                        <div className="absolute -top-4 sm:-top-5 md:-top-6 left-1/2 transform -translate-x-1/2">
                            <div className="px-4 sm:px-5 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full bg-gradient-to-r from-accent to-accent/90 text-white font-bold text-[10px] sm:text-xs md:text-sm uppercase tracking-wide shadow-xl flex items-center gap-1.5 sm:gap-2 whitespace-nowrap">
                        ...
                        {/* Pricing */}
                        <div className="text-center mb-8 sm:mb-10 md:mb-12 pt-3 sm:pt-4 md:pt-0">
                            <div className="flex flex-col items-center justify-center gap-1.5 sm:gap-2 md:gap-4 mb-4 sm:mb-6">
                                <span className="text-base sm:text-lg md:text-2xl text-text-secondary line-through">$144/year</span>
                                <div className="flex items-baseline gap-1 sm:gap-2">
                                    <AnimatedGradientText className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold">
                                        $99
                                    </AnimatedGradientText>
                                    <span className="text-lg sm:text-xl md:text-3xl text-text-secondary">/year</span>
                                </div>
                            </div>
                        ...
                        <div className="space-y-3 sm:space-y-4 md:space-y-5 mb-8 sm:mb-10 md:mb-12">
                            {included.map((feature, i) => (
                                ...
                                >
                                    <div className="flex-shrink-0 w-7 sm:w-8 md:w-10 h-7 sm:h-8 md:h-10 rounded-full bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center shadow-md group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                                    ...
                                    <span className="text-sm sm:text-base md:text-lg lg:text-xl text-text-dark font-medium">{feature}</span>
                                </motion.div>
                            ))}
                        </div>
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-10 md:mb-12 border border-accent/20"
                        >
                            <div className="flex items-start gap-3 sm:gap-4">
                                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center flex-shrink-0">
                                    <Gift className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                                </div>
                                <div>
                                    <p className="text-base sm:text-lg md:text-xl font-bold text-text-dark mb-1 sm:mb-2">
                                        Bonus: Printable Islamic Learning Journal
                                    </p>
