...
describe('getLessonsNeedingReview', () => {
    ...
    it('returns lessons whose review date has passed', () => {
        const records = [
            { lessonId: 'L1', nextReviewDate: '2026-02-17T00:00:00.000Z', completedAt: '2026-02-10T00:00:00.000Z' },
            { lessonId: 'L2', nextReviewDate: '2026-02-20T00:00:00.000Z', completedAt: '2026-02-10T00:00:00.000Z' },
