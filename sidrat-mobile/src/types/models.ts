...
export const categoryMeta: Record<LessonCategory, { label: string; icon: string }> = {
...
export type AvatarId = 'cat' | 'lion' | 'butterfly' | 'owl' | 'rabbit' | 'panda' | 'fox' | 'deer';

export type AchievementCategory = 'progress' | 'mastery' | 'special' | 'social';
