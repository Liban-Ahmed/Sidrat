      ...
      <View style={[styles.header, { marginBottom: spacing.lg }]}>
        <View style={styles.streakInfo}>
          <View style={styles.streakCountRow}>
            <Text style={[typography.title1, { color: colors.text }]}>{streak}</Text>
            <Ionicons
              name="flame"
              size={22}
              color={brand.coral}
          ...
          <Text style={[typography.caption, { color: colors.textTertiary }]}>day streak</Text>
        </View>
                ...
                <View
                  style={[
                    styles.dot,
                    {
                      ...
                      backgroundColor: isDark ? colors.surfaceTertiary : colors.backgroundTertiary,
                    },
                  ]}
                />
              )}
      ...
      >
        {isFullWeek ? (
          <View style={styles.celebrationRow}>
            ...
            <Text style={[typography.captionBold, { color: brand.accent }]}>Perfect week!</Text>
          </View>
        ) : (
