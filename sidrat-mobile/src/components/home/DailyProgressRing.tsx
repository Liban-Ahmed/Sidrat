...
export function DailyProgressRing({
    ...
    return (
        <Animated.View
            entering={FadeInDown.delay(120).duration(600).springify().damping(16)}
        >
            <View
                style={[
                    styles.card,
            ...
            >
                ...
                >
                    <Text style={[typography.caption, { color: colors.textTertiary, letterSpacing: 0.6, textTransform: 'uppercase' }]}>
                        Today
                    </Text>
                    {onSeeAll && (
                        <Pressable onPress={onSeeAll} hitSlop={12}>
                            <Text style={[typography.caption, { color: brand.primary }]}>
                                See all
                            </Text>
                        </Pressable>
                    )}
