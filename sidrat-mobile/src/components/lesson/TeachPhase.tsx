...
export function TeachPhase({ block, index, total, isNarrating, onNarrate, onStopNarration, onNext, isLast, accentColor }: Props) {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Animated.View entering={FadeInDown.delay(150).duration(500)}>
                    <Text style={[typography.title1, { color: colors.text, marginTop: 12, marginBottom: 14 }]}>
                        {block.title}
                    </Text>
                </Animated.View>
                ...
                <Animated.View entering={FadeIn.delay(400).duration(400)} style={styles.speakerRow}>
                    <Pressable
                        onPress={() => handleNarrate(block.narration)}
                        ...
                        {block.keyTerms.map((term, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <Text style={[typography.calloutBold, { color: termColor }]}>
                                            {term.term}
                                        </Text>
                                        <Text
                                            style={[typography.bodySmall, { color: colors.textSecondary, marginTop: 2, lineHeight: 20 }]}
                                        >
                                            {term.definition}
                                        </Text>
                                    </View>
