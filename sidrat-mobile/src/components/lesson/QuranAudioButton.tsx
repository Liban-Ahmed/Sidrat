...
export function QuranAudioButton({
    ...
    useEffect(() => {
        ...
        if (quranRef.globalAyahNumbers && quranRef.globalAyahNumbers.length > 0) {
            console.log('[QuranAudioButton] Using pre-computed global ayah numbers:', quranRef.globalAyahNumbers);
        ...
        async function resolve() {
            ...
            try {
                ...
                console.log('[QuranAudioButton] Resolving surah', quranRef.surah, 'ayah', start, '-', end, 'via API');
                ...
                for (let i = start; i <= end; i++) {
                    ...
                    if (ayah) {
                        ...
                        console.warn('[QuranAudioButton] getAyah returned null for surah', quranRef.surah, 'ayah', i);
                    }
                }
                ...
                <Animated.View
                    style={[
                        styles.button,
                        {
                            ...
                            borderRadius: radius.lg,
                            borderWidth: 1.5,
                            borderColor: isActivelyPlaying
                                ? quranColor
                                : quranColor + (isDark ? '35' : '25'),
                ...
                >
                    ...
                    {isActivelyPlaying && (
                        <View style={styles.waveformContainer}>
                            ...
                            />
                            <Animated.View
                                style={[styles.waveBar, { backgroundColor: '#FFF' }, bar3Style]}
                            />
                            <Animated.View
