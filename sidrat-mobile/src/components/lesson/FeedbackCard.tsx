...
export function FeedbackCard({ type, children, delay = 0, useFormatted = false }: FeedbackCardProps) {
    ...
    const config = {
        ...
        info: { icon: 'information-circle-outline' as const, color: brand.primary, bg: colors.infoMuted },
    }[type];
    ...
    return (
        ...
        >
            ...
            <TextComponent style={[styles.text, { color: colors.text }]}>
                {children}
            </TextComponent>
        </Animated.View>
    );
