...
export const wuduLessons: CurriculumLesson[] = [
    {
        ...
        hook: {
            type: 'hook',
            prompt: 'What do you do before eating dinner? You wash your hands! But did you know Muslims have a special way of washing before they pray?',
        ...
        teach: [
            {
                ...
                narration: 'Wudu is a special way to clean ourselves before we pray. It makes us feel fresh and ready to talk to Allah! The word wudu means beauty and cleanliness.',
                keyTerms: [
            ...
            },
            {
                ...
                narration: 'We make wudu because Allah told us to. The Prophet Muhammad said that cleanliness is half of faith! When we do wudu, we show respect to Allah.',
                arabic: {
...

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'Can you count to three? Great! In wudu, we wash each part of our body three times. Let\'s learn the first steps!',
        ...
        teach: [
            {
                ...
                narration: 'First we say Bismillah. Then we wash our hands three times. We start with the right hand.',
                arabic: {
                    text: 'بِسْمِ اللَّهِ',
                    transliteration: 'Bismillah',
            ...
            },
            {
                ...
                narration: 'After washing our hands, we rinse our mouth three times. We take water in our right hand, swish it around, and spit it out.',
                keyTerms: [
                    { term: 'Madmadah', definition: 'Rinsing the mouth during wudu' },
                ],
            ...
            },
            {
                ...
                narration: 'Then we gently put water in our nose and blow it out three times. Use the right hand for water and the left hand to clean.',
                keyTerms: [
                    { term: 'Istinshaq', definition: 'Sniffing water into the nose during wudu' },
                ],
        ...
        practice: [
            {
                ...
                explanation: 'The correct order is: Bismillah, then hands, mouth, and nose — each three times!',
            },
            {
                id: 'wudu-01-02-p2',
                type: 'quiz',
                ...
                correctIndex: 2,
                points: 10,
                explanation: 'We wash each part three times in wudu, following the Sunnah of the Prophet ﷺ.',
            },
            {
                id: 'wudu-01-02-p3',
                type: 'fill-blank',
        ...
        reward: {
            ...
            funFact: 'The Prophet ﷺ never wasted water during wudu. He used about 1 mudd (roughly 750ml) — less than a small bottle!',
        },
    },

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'You already learned three steps of wudu — amazing! Now imagine water gently washing your face like a refreshing breeze. Ready to learn more?',
        ...
        teach: [
            {
                ...
                narration: 'Now we wash our face three times. From the forehead to the chin, and from ear to ear. Use both hands to splash water on your face.',
            ...
            },
            {
                ...
                narration: 'Next we wash our arms. Start with the right arm, then the left. Wash from the fingertips to the elbows, three times each.',
        ...
        practice: [
            ...
            },
            {
                ...
                correctAnswer: true,
                points: 10,
                explanation: 'Correct! We wash from fingertips to elbows, making sure to include the elbows.',
            },
            {
                id: 'wudu-01-03-p4',
                type: 'ordering',
        ...
        reward: {
            ...
            funFact: 'On the Day of Judgment, the Prophet ﷺ will recognize his ummah by the shining marks of wudu on their faces and arms!',
        },
    },

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'You\'re almost done learning all the steps of wudu! Just two more parts to go. Can you guess what they are?',
        ...
        teach: [
            {
                ...
                narration: 'This step is different. We wipe our head with wet hands, not wash it. Front to back, then back to front. We do this only one time!',
                keyTerms: [
                    { term: 'Masah', definition: 'Wiping (the head) with wet hands during wudu' },
                ],
            ...
            },
            {
                ...
                narration: 'Then we wipe our ears. Put your pointing fingers inside your ears and your thumbs behind them. We do this once.',
            ...
            },
            {
                ...
                narration: 'Last step! Wash your feet three times each. Right foot first, then left. Do not forget between the toes!',
        ...
        practice: [
            {
                ...
                explanation: 'The head is wiped only once, unlike other parts which are washed three times!',
            },
            {
                id: 'wudu-01-04-p2',
                type: 'true-false',
                ...
                correctAnswer: false,
                points: 10,
                explanation: 'We wipe (masah) our head with wet hands — we don\'t wash it with flowing water.',
            },
            {
                id: 'wudu-01-04-p3',
                type: 'ordering',
        ...
        reward: {
            ...
            funFact: 'Prophet Muhammad ﷺ never wasted water. He would use just a small amount, teaching us to care for nature too!',
            bonusDua: {
                ...
                translation: 'I bear witness that there is no god but Allah alone with no partner, and I bear witness that Muhammad is His servant and messenger — Say this after wudu!',
            },
        },
    },

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'You\'ve learned all about wudu! Now it\'s time to prove what you know and become a Wudu Master!',
        ...
        teach: [
            {
                ...
                narration: 'Let us review! Remember Bismillah, then hands, mouth, nose, face, arms, head, ears, and feet. Then say the dua after wudu!',
        ...
        reward: {
            ...
            funFact: 'Amazing job! You completed the Wudu unit. On the Day of Judgment, the parts washed in wudu will shine with light!',
            bonusDua: {
