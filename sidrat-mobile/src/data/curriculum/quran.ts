...
export const quranLessons: CurriculumLesson[] = [
...

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'Imagine getting a letter from the most important person ever — not just any letter, but a perfect guide for your whole life. That is what the Quran is — a message from Allah to all of us!',
            narration: 'Imagine getting a special message from the most important being ever. The Quran is a message from Allah to all of humanity. Let us learn about this amazing book!',
        ...
        teach: [
            {
                ...
                narration: 'The Quran is the holy book of Islam. It is the word of Allah, sent to Prophet Muhammad through the angel Jibreel. It has 114 chapters called surahs.',
                keyTerms: [
            ...
            },
            {
                ...
                narration: "The Quran is special because it is Allah's own words. It has never been changed. It guides us in life. And just reading it earns us rewards from Allah!",
                arabic: {
        ...
        reward: {
            ...
            funFact: 'The Quran has been memorized completely by millions of people, including young children! People who memorize the whole Quran are called "Hafiz".',
            bonusDua: {
...

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'There is one surah that every Muslim recites at least 17 times a day! It is the very first surah in the Quran. Do you know its name?',
            narration: 'There is a surah that Muslims recite at least 17 times every day in their prayers. It is called Surah Al-Fatiha, the Opening. Let us learn it together!',
        ...
        teach: [
            {
                ...
                narration: 'Surah Al-Fatiha means The Opening. It has 7 beautiful verses. The Prophet said it is the greatest surah in the Quran. We recite it in every prayer.',
                arabic: {
            ...
            },
            {
                ...
                narration: 'Al-Fatiha is a conversation with Allah. We praise Him. We remember His mercy. And we ask Him for guidance to the straight path.',
                arabic: {
        ...
        practice: [
            ...
            },
            {
                ...
                explanation: 'Bismillahir-Rahmanir-Raheem — In the name of Allah, the Most Merciful, the Especially Merciful.',
            },
            {
                id: 'qur-01-02-p3',
                type: 'matching',
        ...
        reward: {
            ...
            funFact: 'Al-Fatiha is also called "Umm al-Quran" (Mother of the Quran) and "As-Sab\' al-Mathani" (The Seven Oft-Repeated Verses).',
            bonusDua: {
...

    {
        ...
        hook: {
            type: 'hook',
            prompt: 'Did you know there is a surah so powerful that reciting it is like reading one-third of the entire Quran? It is only 4 verses long! Can you guess which one?',
            narration: 'There is a surah so powerful that it equals one-third of the Quran! And it is very short. Let us discover these amazing short surahs together!',
        ...
        teach: [
            {
                ...
                narration: 'Surah Al-Ikhlas has only 4 verses. It teaches us about Tawheed, that Allah is One. The Prophet said reciting it equals one-third of the Quran!',
                arabic: {
                ...
                keyTerms: [
                    ...
                    { term: 'As-Samad', definition: 'The Self-Sufficient — Allah needs nothing, everything needs Him' },
                ],
            ...
            },
            {
                ...
                narration: 'The last two surahs are called The Two Protectors. In Al-Falaq, we ask Allah to protect us from evil. In An-Nas, we ask Allah to protect us from bad thoughts. The Prophet recited them every night!',
                arabic: {
        ...
        practice: [
            {
                ...
                correctIndex: 1,
                points: 10,
                explanation: 'Surah Al-Ikhlas is equal to one-third of the Quran because it perfectly explains Tawheed!',
            },
            {
                id: 'qur-01-03-p2',
                type: 'matching',
            ...
            },
            {
                ...
                correctAnswer: true,
                points: 10,
                explanation: 'Yes! The Prophet ﷺ would recite these protection surahs every night before sleeping.',
            },
        ],

        reward: {
            message: "Mashallah! You learned three powerful surahs! You're becoming a Quran reader! 🌙",
            funFact: 'If you recite Surah Al-Ikhlas 3 times, it equals the reward of reciting the entire Quran once! Try it tonight before you sleep.',
            bonusDua: {
