...
export interface Dua {
    ...
    category: 'morning' | 'evening' | 'food' | 'travel' | 'sleep' | 'general' | 'protection' | 'gratitude';
...
export const dailyDuas: Dua[] = [
    ...
    },
    {
        ...
        translation: 'O Allah, by You we enter the morning, by You we enter the evening, by You we live and by You we die.',
        category: 'morning',
    ...
    },
    {
        ...
        translation: 'I seek refuge in Allah, the All-Hearing, the All-Knowing, from the accursed Shaytan.',
        category: 'evening',
