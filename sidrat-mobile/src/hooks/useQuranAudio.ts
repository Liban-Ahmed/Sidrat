...
export function useQuranAudio() {
    ...
    const play = useCallback(
        async (globalAyahNumber: number, onFinish?: () => void) => {
            ...
            sequenceRef.current.active = false;
            setState({ playingAyah: globalAyahNumber, isPlaying: false, isLoading: true, isSequence: false });
            ...
            try {
                ...
                setState({ playingAyah: globalAyahNumber, isPlaying: true, isLoading: false, isSequence: false });
            } catch (err) {
